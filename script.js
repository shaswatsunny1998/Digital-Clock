...
var time, alarm, currentH, currentM,
    activeAlarm = false,
    sound = new Audio("316847_4939433-lq.mp3");
...
snooze.onclick = function () {
    ...
    function MoveDiv2() {
        ...
        div.style.top = parseInt(div.style.bottom) + 10 + "px";
    }
    //    function myFunction1() {
    //        document.getElementsByClassName("cell").style.top = "300px";
    //    }
    //
    //    function myFunction2() {
    //        document.getElementsByClassName("cell").style.bottom = "300px";
    //    }
